...
## Network Spec Fields (for `fabric_create_slice` tool)
...
**Note:** The `fabric_create_slice` tool takes simple node names in `interfaces`
and auto-creates NICs. When writing `template.fabric.json` files directly, you
